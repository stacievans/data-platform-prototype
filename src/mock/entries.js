...
const DEMO_OVERRIDES = {
  ...
  'E-200201': {
    ...
    acceptOperator: { nickname: '陈静', id: 'U-2002' },
    acceptTime: '2026-06-09 15:30:00',
    flowHistory: [
      { label: '验收通过（第1轮）', round: 1, time: '2026-06-09 15:30:00', operator: '陈静(U-2002)' },
  ...
  'E-200202': {
    ...
    reviewTime: '2026-06-08 11:40:00',
    acceptOperator: { nickname: '陈静', id: 'U-2002' },
    acceptTime: '2026-06-09 16:20:00',
    flowHistory: [
      { label: '验收通过（第1轮）', round: 1, time: '2026-06-09 16:20:00', operator: '陈静(U-2002)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-08 11:40:00', operator: '孙丽(U-2001)' },
  ...
  'E-200203': {
    ...
    reviewOperator: { nickname: '何敏', id: 'U-2003' },
    reviewTime: '2026-06-07 18:30:00',
    flowHistory: [
      { label: '标注驳回（第1轮）', round: 1, time: '2026-06-07 18:30:00', operator: '何敏(U-2003)' },
  ...
  'E-200204': {
    dataStatus: '已标注',
    qcTime: '2026-06-06 09:15:00',
    reviewOperator: { nickname: '孙丽', id: 'U-2001' },
    reviewTime: '2026-06-07 14:20:00',
    flowHistory: [
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-07 14:20:00', operator: '孙丽(U-2001)' },
      { label: '质检通过', round: 1, time: '2026-06-06 09:15:00', operator: '系统自动' },
    ],
    auditScore: 4,
    auditResult: '通过',
    auditQuality: '中质量',
    auditTags: [],
    auditComment: '标注完成，待验收。',
    actionSegments: DEFAULT_ACTION_SEGMENTS,
    regionFrames: DEFAULT_REGION_FRAMES,
  },
  'E-200205': {
    dataStatus: '已验收',
    qcTime: '2026-06-05 10:30:00',
    reviewOperator: { nickname: '吴磊', id: 'U-2005' },
    reviewTime: '2026-06-06 11:00:00',
    acceptOperator: { nickname: '陈静', id: 'U-2002' },
    acceptTime: '2026-06-08 09:45:00',
    flowHistory: [
      { label: '验收通过（第1轮）', round: 1, time: '2026-06-08 09:45:00', operator: '陈静(U-2002)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-06 11:00:00', operator: '吴磊(U-2005)' },
      { label: '质检通过', round: 1, time: '2026-06-05 10:30:00', operator: '系统自动' },
    ],
    auditScore: 5,
    auditResult: '通过',
    auditQuality: '高质量',
  ...
  'E-200301': {
    dataStatus: '验收不通过',
    qcTime: '2026-06-04 08:40:00',
    reviewOperator: { nickname: '孙丽', id: 'U-2001' },
    reviewTime: '2026-06-05 15:10:00',
    acceptOperator: { nickname: '陈静', id: 'U-2002' },
    acceptTime: '2026-06-07 11:25:00',
    flowHistory: [
      { label: '验收驳回（第1轮）', round: 1, time: '2026-06-07 11:25:00', operator: '陈静(U-2002)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-05 15:10:00', operator: '孙丽(U-2001)' },
      { label: '质检通过', round: 1, time: '2026-06-04 08:40:00', operator: '系统自动' },
    ],
    auditScore: 3,
    auditResult: '通过',
    auditQuality: '中质量',
  ...
  'E-200306': {
    dataStatus: '已验收',
    qcTime: '2026-06-02 09:00:00',
    reviewOperator: { nickname: '孙丽', id: 'U-2001' },
    reviewTime: '2026-06-03 10:30:00',
    acceptOperator: { nickname: '陈静', id: 'U-2002' },
    acceptTime: '2026-06-04 14:00:00',
    flowHistory: [
      { label: '验收通过（第1轮）', round: 1, time: '2026-06-04 14:00:00', operator: '陈静(U-2002)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-03 10:30:00', operator: '孙丽(U-2001)' },
      { label: '质检通过', round: 1, time: '2026-06-02 09:00:00', operator: '系统自动' },
    ],
    auditScore: 4,
    auditResult: '通过',
    auditQuality: '中质量',
  ...
  'E-200307': {
    dataStatus: '验收不通过',
    qcTime: '2026-06-01 11:20:00',
    reviewOperator: { nickname: '孙丽', id: 'U-2001' },
    reviewTime: '2026-06-02 16:45:00',
    acceptOperator: { nickname: '陈静', id: 'U-2002' },
    acceptTime: '2026-06-03 09:30:00',
    flowHistory: [
      { label: '验收驳回（第1轮）', round: 1, time: '2026-06-03 09:30:00', operator: '陈静(U-2002)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-02 16:45:00', operator: '孙丽(U-2001)' },
      { label: '质检通过', round: 1, time: '2026-06-01 11:20:00', operator: '系统自动' },
    ],
    auditScore: 3,
    auditResult: '通过',
    auditQuality: '中质量',
  ...
  'E-200501': {
    dataStatus: '已验收',
    qcTime: '2026-06-08 08:30:00',
    reviewOperator: { nickname: '何敏', id: 'U-2003' },
    reviewTime: '2026-06-09 11:15:00',
    acceptOperator: { nickname: '林峰', id: 'U-2010' },
    acceptTime: '2026-06-10 10:00:00',
    flowHistory: [
      { label: '验收通过（第1轮）', round: 1, time: '2026-06-10 10:00:00', operator: '林峰(U-2010)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-09 11:15:00', operator: '何敏(U-2003)' },
      { label: '质检通过', round: 1, time: '2026-06-08 08:30:00', operator: '系统自动' },
    ],
    auditScore: 5,
    auditResult: '通过',
    auditQuality: '高质量',
    auditTags: [],
    auditComment: '切配动作连贯，标注准确。',
    acceptResult: '通过',
    acceptComment: '验收通过。',
    actionSegments: DEFAULT_ACTION_SEGMENTS,
    regionFrames: DEFAULT_REGION_FRAMES,
  ...
  'E-200502': {
    dataStatus: '已标注',
    qcTime: '2026-06-07 09:45:00',
    reviewOperator: { nickname: '何敏', id: 'U-2003' },
    reviewTime: '2026-06-08 13:20:00',
    flowHistory: [
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-08 13:20:00', operator: '何敏(U-2003)' },
      { label: '质检通过', round: 1, time: '2026-06-07 09:45:00', operator: '系统自动' },
    ],
    auditScore: 4,
    auditResult: '通过',
    auditQuality: '中质量',
  ...
  'E-200503': {
    dataStatus: '已验收',
    qcTime: '2026-06-06 10:00:00',
    reviewOperator: { nickname: '何敏', id: 'U-2003' },
    reviewTime: '2026-06-07 15:30:00',
    acceptOperator: { nickname: '林峰', id: 'U-2010' },
    acceptTime: '2026-06-09 09:20:00',
    flowHistory: [
      { label: '验收通过（第1轮）', round: 1, time: '2026-06-09 09:20:00', operator: '林峰(U-2010)' },
      { label: '标注通过（第1轮）', round: 1, time: '2026-06-07 15:30:00', operator: '何敏(U-2003)' },
      { label: '质检通过', round: 1, time: '2026-06-06 10:00:00', operator: '系统自动' },
    ],
    auditScore: 4,
    auditResult: '通过',
    auditQuality: '中质量',
    auditTags: [],
    auditComment: '关键步骤均已覆盖。',
    acceptResult: '通过',
    acceptComment: '同意入库。',
    actionSegments: DEFAULT_ACTION_SEGMENTS,
    regionFrames: DEFAULT_REGION_FRAMES,
