...
export const openDashboard = {
  ...
  recentIngestion: [
    { name: 'Open X-Embodiment', publisher: 'Google DeepMind', level: 'L4', status: '已入库', count: '100万+ 轨迹', date: '2026-04-08' },
    { name: 'AgiBot World', publisher: '智元机器人', level: 'L4', status: '入库中', count: '100万 轨迹', date: '2026-06-02' },
    { name: 'RH20T', publisher: '上海交通大学', level: 'L3', status: '入库中', count: '11万 轨迹', date: '2026-05-28' },
    { name: 'RoboMIND', publisher: '国地共建具身智能中心', level: 'L3', status: '已入库', count: '5.5万 轨迹', date: '2026-04-22' },
    { name: 'DROID', publisher: 'Stanford', level: 'L4', status: '已入库', count: '7.6万 轨迹', date: '2026-03-15' },
    { name: 'BridgeData V2', publisher: 'UC Berkeley', level: 'L2', status: '已入库', count: '6万 轨迹', date: '2026-03-08' },
    { name: 'RT-1 Robot Action', publisher: 'Google', level: 'L2', status: '已入库', count: '13万 轨迹', date: '2026-02-20' },
    { name: 'CALVIN', publisher: 'Freiburg University', level: 'L3', status: '已入库', count: '2.4万 轨迹', date: '2026-01-14' },
    { name: 'RoboSet', publisher: 'CMU', level: 'L4', status: '未入库', count: '9.8万 轨迹', date: '2025-12-30' },
    { name: 'BC-Z', publisher: 'Google / Stanford', level: 'L4', status: '未入库', count: '2.6万 轨迹', date: '2025-11-18' },
  ],
}
