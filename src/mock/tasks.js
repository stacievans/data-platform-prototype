...
export const tasks = [
  {
    ...
    status: '已归档', collector: '刘伟', reviewer: '孙丽',
  ...
  },
  {
    ...
    status: '已发布', collector: '周杰', reviewer: '孙丽',
  ...
  },
  {
    ...
    status: '已发布', collector: '吴磊', reviewer: '何敏',
  ...
  },
  {
    ...
    status: '已发布', collector: '郑浩', reviewer: '钱琳',
  ...
  },
  {
    ...
    status: '已发布', collector: '刘伟', reviewer: '何敏',
  ...
  },
  {
    ...
    status: '已发布', collector: '吴磊', reviewer: '钱琳',
...
/** 采集员、标注员均为单人字符串（兼容历史数组仅取首项） */
export const toPeopleArray = (value) => (Array.isArray(value) ? value : value ? [value] : [])
