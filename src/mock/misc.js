...
export const collectTagGroups = {
  ...
  sceneType: [
    { id: 'CT-201', name: '家居服务', description: '家庭室内环境下的机器人服务采集场景', creator: '李明', createdAt: '2026-03-12', updatedAt: '2026-03-12' },
    { id: 'CT-202', name: '工业服务', description: '工厂或仓库等工业环境下的操作采集场景', creator: '李明', createdAt: '2026-03-12', updatedAt: '2026-04-15' },
    { id: 'CT-203', name: '公共服务', description: '商场、餐厅等公共场所服务场景', creator: '王芳', createdAt: '2026-04-02', updatedAt: '2026-04-02' },
  ],
  collectionMethod: [
...
export const annotationTemplates = [
  { id: 'AT-301', name: '桌面抓取标注模板', createdAt: '2026-03-18', updatedAt: '2026-04-20' },
  { id: 'AT-302', name: '导航避障模板', createdAt: '2026-03-26', updatedAt: '2026-03-26' },
  { id: 'AT-303', name: '回流标注模板', createdAt: '2026-05-01', updatedAt: '2026-05-14' },
]
...
// 系统管理 - 用户
export const users = [
  { id: 1, uid: 'U-001', username: 'zhanghua',  nickname: '张华', phone: '138****2201', role: '管理员',   status: '启用' },
  { id: 2, uid: 'U-002', username: 'liming',   nickname: '李明',   phone: '139****8512', role: '平台运营', status: '启用' },
  { id: 3, uid: 'U-003', username: 'wangfang', nickname: '王芳',   phone: '136****3308', role: '平台运营', status: '启用' },
  { id: 4, uid: 'U-004', username: 'liuwei',   nickname: '刘伟',   phone: '137****9914', role: '采集员',   status: '启用' },
  { id: 5, uid: 'U-005', username: 'zhoujie',  nickname: '周杰',   phone: '135****6627', role: '采集员',   status: '启用' },
  { id: 6, uid: 'U-006', username: 'sunli',    nickname: '孙丽',   phone: '188****4053', role: '标注员',   status: '启用' },
  { id: 7, uid: 'U-007', username: 'hemin',    nickname: '何敏',   phone: '186****7740', role: '标注员',   status: '停用' },
