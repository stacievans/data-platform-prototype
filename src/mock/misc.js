...
export const projectMembers = {
  'P-1001': [
    ...
    { id: 'PM-1001-4', uid: 'U-006', username: 'sunli', role: '标注员', taskIds: ['BT-001', 'BT-002', 'BT-003'], joinedAt: '2026-03-13 11:20:00' },
    { id: 'PM-1001-5', uid: 'U-007', username: 'hemin', role: '标注员', taskIds: ['BT-003'], joinedAt: '2026-03-28 16:45:00' },
    { id: 'PM-1001-6', uid: 'U-011', username: 'wulei', role: '采集员', taskIds: ['T-2004'], joinedAt: '2026-04-10 09:00:00' },
    { id: 'PM-1001-7', uid: 'U-011', username: 'wulei', role: '标注员', taskIds: ['BT-001'], joinedAt: '2026-04-10 09:05:00' },
    { id: 'PM-1001-8', uid: 'U-016', username: 'chenjing', role: '验收员', taskIds: ['BT-001', 'BT-002', 'BT-003'], joinedAt: '2026-04-22 10:00:00' },
    { id: 'PM-1001-9', uid: 'U-017', username: 'linfeng', role: '验收员', taskIds: ['BT-001', 'BT-004'], joinedAt: '2026-05-08 15:00:00' },
  ],
  'P-1002': [
    ...
    { id: 'PM-1002-3', uid: 'U-007', username: 'hemin', role: '标注员', taskIds: ['BT-101'], joinedAt: '2026-03-22 15:22:00' },
    { id: 'PM-1002-4', uid: 'U-017', username: 'linfeng', role: '验收员', taskIds: ['BT-101'], joinedAt: '2026-05-08 15:00:00' },
  ],
  'P-1003': [
