...
const initialBatches = [
  {
    ...
    detailItems: [
      { label: '客厅杂物分拣-第1批 · 审核通过', totalEntries: 80, ratio: 20, sampledEntries: 16, passRate: 93.8 },
      { label: '客厅杂物分拣-第1批 · 审核驳回', totalEntries: 40, ratio: 20, sampledEntries: 8, passRate: 87.5 },
      { label: '客厅杂物分拣-第2批 · 审核通过', totalEntries: 64, ratio: 20, sampledEntries: 13, passRate: 92.3 },
    ],
  ...
  },
  {
    ...
    configItems: [
      { key: 'T-2002:审核通过', label: '客厅杂物分拣-第2批 · 审核通过', totalEntries: 80, ratio: 20 },
      { key: 'T-2002:审核驳回', label: '客厅杂物分拣-第2批 · 审核驳回', totalEntries: 40, ratio: 20 },
    ],
    detailItems: [
      { label: '客厅杂物分拣-第2批 · 审核通过', totalEntries: 80, ratio: 20, sampledEntries: 16, passRate: 93.8 },
      { label: '客厅杂物分拣-第2批 · 审核驳回', totalEntries: 40, ratio: 20, sampledEntries: 8, passRate: 87.5 },
    ],
  ...
  },
  {
    ...
    configItems: [
      { key: 'T-2003:待验收', label: '卧室物品归位采集 · 待验收', totalEntries: 90, ratio: 10 },
      { key: 'T-2003:验收不通过', label: '卧室物品归位采集 · 验收不通过', totalEntries: 34, ratio: 15 },
    ],
    detailItems: [
      { label: '卧室物品归位采集 · 待验收', totalEntries: 90, ratio: 10, sampledEntries: 9, passRate: 55.6 },
      { label: '卧室物品归位采集 · 验收不通过', totalEntries: 34, ratio: 15, sampledEntries: 6, passRate: 33.3 },
    ],
  ...
  },
  {
    ...
    detailItems: [
      { label: '蔬菜切配-土豆丝 · 审核通过', totalEntries: 50, ratio: 20, sampledEntries: 10, passRate: 95.0 },
      { label: '餐具清洗采集 · 审核通过', totalEntries: 38, ratio: 20, sampledEntries: 8, passRate: 100 },
    ],
  ...
  },
  {
    ...
    detailItems: [
      { label: '吴磊 · 审核通过', totalEntries: 52, ratio: 15, sampledEntries: 8, passRate: 75.0 },
      { label: '郑浩 · 审核通过', totalEntries: 36, ratio: 15, sampledEntries: 6, passRate: 66.7 },
    ],
  ...
  },
  {
    ...
    detailItems: [
      { label: '何敏 · 审核通过', totalEntries: 70, ratio: 10, sampledEntries: 7, passRate: 85.7 },
      { label: '何敏 · 审核驳回', totalEntries: 18, ratio: 10, sampledEntries: 2, passRate: 50.0 },
    ],
    entryIds: ['E-200702'],
  },
]
